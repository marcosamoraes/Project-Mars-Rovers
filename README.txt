Project for job in the Zup IT Innovation company.
By: Marcos A. A. Moraes.

Instructions

First of all the user key in the maximum and minimum of X and Y co-ordinates.

Then, the user needs set the rover's position(X, Y and the direction).
